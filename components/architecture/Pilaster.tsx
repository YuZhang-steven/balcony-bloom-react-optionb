...
import { line } from '../ironwork/strokeBuilder';
...
export function Pilaster({ x, topY, bottomY, w = 38, sequence }: PilasterProps) {
  ...
  return (
    <g className="pilaster">
      <IronStroke stroke={line([cx - w / 2, topY], [cx - w / 2, bottomY], { w: 3.8, color: IRON.deep })} />
      <IronStroke stroke={line([cx + w / 2, topY], [cx + w / 2, bottomY], { w: 3.8, color: IRON.deep })} />
      <IronStroke stroke={line([cx, topY + 4], [cx, bottomY - 4], { w: 1.8, color: IRON.mid })} />
